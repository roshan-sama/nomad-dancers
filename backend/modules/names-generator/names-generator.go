// Package namesgenerator generates random names, based on the Docker name generator
// It has been modified to use the stronger crypto/rand library

// The following comments are from the original Docker repo:
...
begin:
	...
	name := left[leftIndex.Int64()] + "_" + right[rightIndex.Int64()]
	...
	if retry > 0 {
		digitIndex, _ := rand.Int(rand.Reader, big.NewInt(10))
		name += strconv.Itoa(int(digitIndex.Int64()))
	}
